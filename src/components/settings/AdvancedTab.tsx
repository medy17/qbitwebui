...
export function AdvancedTab({ preferences, onChange }: Props) {
	return (
		<div className="space-y-4">
			<div className="px-3 py-2 rounded flex items-start gap-2" style={{ backgroundColor: 'color-mix(in srgb, var(--warning) 15%, transparent)', border: '1px solid var(--warning)' }}>
				<svg className="w-4 h-4 shrink-0 mt-0.5" style={{ color: 'var(--warning)' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
					<path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
				</svg>
				<p className="text-xs" style={{ color: 'var(--text-secondary)' }}>Incorrect values may affect performance or stability.</p>
			</div>
